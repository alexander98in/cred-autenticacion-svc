...
public enum ErrorCodeDomain {
    ...
    EMAIL_ALREADY_EXISTS("CRED-3001", "El email %s ya está registrado"),
    DOCUMENT_NUMBER_ALREADY_EXISTS("CRED-3002", "El número de documento %s ya está registrado"),
    USER_NOT_FOUND("CRED-4001", "Usuario no encontrado por %s: %s"),
    INVALID_CREDENTIALS("CRED-7003", "Las credenciales proporcionadas no son válidas"),
